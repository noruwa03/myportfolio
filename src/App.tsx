          ...
          <div className="grid sm:grid-cols-8 grid-cols-4 gap-x-8 lg:gap-y-20 gap-y-8 items-center">
            ...
            <div className="sm:col-span-2 col-span-4">
              ...
              <div className="mt-4 flex space-x-8">
                ...
                <a
                  href="https://github.com/noruwa03/Ecommerce-Firebase"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block"
                >
            ...
            <div className="sm:col-span-2 col-span-4">
              ...
              <div className="mt-4 flex space-x-8">
                ...
                <a
                  href="https://github.com/noruwa03/DraftBlog"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block"
                >
            ...
            <div className="sm:col-span-2 col-span-4">
              ...
              <div className="mt-4 flex space-x-8">
                ...
                <a
                  href="https://github.com/noruwa03/DictionaryApp"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block"
                >
            ...
            <div className="sm:col-span-2 col-span-4">
              ...
              <div className="mt-4 flex space-x-8">
                ...
                <a
                  href="https://github.com/noruwa03/TodoApp"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block"
                >
            ...
            <div className="sm:col-span-2 col-span-4">
              ...
              <div className="mt-4 flex space-x-8">
                ...
                <a
                  href="https://github.com/noruwa03/NFT-Marketplace"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block"
                >
